  ...
  return (
    <>
      ...
      <header id="header">
        <div className="left">
          ...
          <div className="taskbar-apps">
            <Link
              href={"/menu"}
              className={`btn btn-nav sd ${pathname.includes("/menu") ? "active" : ""}`}
            >
              <svg
                width="56"
                height="56"
            ...
            <Link
              href={"/profile"}
              className={`btn btn-nav ${pathname.includes("/profile") ? "active" : ""}`}
            >
              <IoMdPerson />
            </Link>
            <Link
      ...
      <header id="header-mobile">
        <Link
          href={"/menu"}
          className={`btn btn-nav ${pathname.includes("/menu") ? "active" : ""}`}
        >
          <svg
            width="56"
            height="56"
        ...
        <Link
          href={"/clock"}
          className={`btn btn-nav ${pathname.includes("/clock") ? "active" : ""}`}
        >
          <svg
            width="25"
            height="28"
        ...
        <Link
          href={"/settings"}
          className={`btn btn-nav ${pathname.includes("/settings") ? "active" : ""}`}
        >
          {/* Add Audio setting and go to classic mode */}
          <BiSolidCog />
          <span>SETTING</span>
        </Link>
      </header>
